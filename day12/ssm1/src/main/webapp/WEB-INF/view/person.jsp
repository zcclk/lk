					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>人员性别：</td>
								<td>
								<input type="radio" id="gender" name="gender" aria-required="true" value="男" required/>男
								<input type="radio" id="gender" name="gender" aria-required="true" value="女" required/>女</td>
							</tr>
							<tr>
								<td>年龄：</td>
								...
								<td>生日：</td>
								<td>
								<input id="birthday" name="birthday" readonly="readonly" class="laydate-icon form-control layer-date" aria-required="true" required/>
							</tr>
